...
/** Basically the same as `ScrollArea` above but can specify custom scrollbar */
const ScrollAreaWithCustomScrollBar = React.forwardRef<
  React.ElementRef<typeof ScrollAreaPrimitive.Root>,
  React.ComponentPropsWithoutRef<typeof ScrollAreaPrimitive.Root> & {
...
>(({ className, children, scrollbar, ...props }, ref) => (
  ...
  >
    ...
    {scrollbar !== undefined ? scrollbar : <ScrollBar />}
    <ScrollAreaPrimitive.Corner />
  </ScrollAreaPrimitive.Root>
))
ScrollAreaWithCustomScrollBar.displayName = ScrollAreaPrimitive.Root.displayName

/** Basically the same as `ScrollBar` above but can specify custom scrollbar thumb */
const ScrollBarWithCustomThumb = React.forwardRef<
  React.ElementRef<typeof ScrollAreaPrimitive.ScrollAreaScrollbar>,
...
>(({ className, orientation = 'vertical', thumb, ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ref={ref}
    orientation={orientation}
    className={cn(
...
ScrollBarWithCustomThumb.displayName =
