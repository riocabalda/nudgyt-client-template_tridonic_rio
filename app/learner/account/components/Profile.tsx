  ...
  return (
    <Card className='shadow-sm rounded-none lg:rounded-[8px] py-[40px] px-4 lg:px-[80px] flex flex-col gap-[24px] items-center w-full lg:max-w-[600px]'>
      <Avatar className='size-[80px]'>
        <AvatarFallback className='text-white bg-[#F3706F] text-[36px]'>
      ...
      <div className='grid items-stretch w-full grid-cols-1 gap-4 lg:grid-cols-2'>
        <Link
          href='/learner/account/mobile/personal-details'
          className='lg:hidden'
        >
        ...
        <Link
          href='/learner/account/personal-details'
        ...
        <Link
          href='/learner/account/mobile/change-password'
          className='lg:hidden'
        >
          <Button variant='outline' className='w-full'>
            Change Password
        ...
        <Link
          href='/learner/account/change-password'
          className='hidden lg:block'
        >
          <Button variant='outline' className='w-full'>
            Change Password
